...
namespace Erpmi.Controllers
{
    ...
    {
        private readonly IAccountManager<ApplicationUser, int, ApplicationRole, int> _accountManager;
        private readonly IAuthorizationService _authorizationService;
        private const string GetUserByIdActionName = "GetUserById";
        private const string GetRoleByIdActionName = "GetRoleById";

        public AccountController(IAccountManager<ApplicationUser, int, ApplicationRole, int> accountManager, IAuthorizationService authorizationService)
        {
        ...
        [HttpGet("users")]
        [Authorize(Policies.ViewAllUsers)]
        ...
        public async Task<IActionResult> UpdateUser(int id, [FromBody] UserEditViewModel user)
        {
            ...
            var assignRolePolicy = _authorizationService.AuthorizeAsync(this.User, Tuple.Create(user.Roles, currentRoles), Policies.AssignAllowedRoles);
        ...
        [HttpPost("users")]
        [Authorize(Policies.ManageAllUsers)]
        [ProducesResponseType(201, Type = typeof(UserViewModel))]
        [ProducesResponseType(400)]
        [ProducesResponseType(403)]
        public async Task<IActionResult> Register([FromBody] UserEditViewModel user)
        {
            if (!(await _authorizationService.AuthorizeAsync(this.User, Tuple.Create(user.Roles, new string[] { }), Policies.AssignAllowedRoles)).Succeeded)
                return new ChallengeResult();
        ...
        public async Task<IActionResult> GetRoleById(int id)
        {
            ...
            if (!(await _authorizationService.AuthorizeAsync(this.User, appRole?.Name ?? "", Policies.ViewRoleByRoleName)).Succeeded)
                return new ChallengeResult();
        ...
        {
            if (!(await _authorizationService.AuthorizeAsync(this.User, name, Policies.ViewRoleByRoleName)).Succeeded)
                return new ChallengeResult();
        ...
        [HttpGet("roles")]
        [Authorize(Policies.ViewAllRoles)]
        ...
        [HttpPut("roles/{id}")]
        [Authorize(Policies.ManageAllRoles)]
        [ProducesResponseType(204)]
        [ProducesResponseType(400)]
        [ProducesResponseType(404)]
        ...
        {
            return Ok(Mapper.Map<List<PermissionViewModel>>(Permissions.AllPermissions));
        }
